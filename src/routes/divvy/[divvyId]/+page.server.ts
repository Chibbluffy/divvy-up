...
import { getDivvyById, getAccessLevel, getPeople, getEvents, getIntersections } from '$lib/server/db';
...
export const load: PageServerLoad = async ({ params, url }) => {
	...
	return { divvy: divvyData, people, events, intersections, accessLevel, token };
};
